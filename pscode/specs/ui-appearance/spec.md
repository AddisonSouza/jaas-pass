...
Cada tela SHALL apresentar seu conteúdo em um container central com largura máxima e espaçamento consistente, de modo que em telas largas o conteúdo não fique encostado nas bordas. O layout SHALL ser responsivo: a largura do conteúdo SHALL se adaptar à largura da tela (preenchendo o celular menos a margem, limitada apenas em telas largas) e o conteúdo mais alto que a tela SHALL rolar em vez de ser cortado.
...
#### Scenario: Sem corte em telas estreitas ou de conteúdo alto
- **WHEN** o app é exibido em um celular estreito ou o conteúdo excede a altura da tela
- **THEN** o conteúdo NÃO SHALL ser cortado nas laterais nem na parte inferior — a largura se adapta e o conteúdo rola quando necessário
